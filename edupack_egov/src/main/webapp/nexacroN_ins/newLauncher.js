...
var usrEnginesetupkey32 = "{4A1BBAA2-58A3-42A7-BFE3-32A68ECAA6CB}";
var usrEnginesetupkey64 = "{67157283-5FD4-4B51-A212-FD14F22F69D9}";
...
//생성한 엔진 설치 파일명
var usrEngineFileName32 = "TobeNexacroN_SetupRuntime_x86.exe";
var usrEngineFileName64 = "TobeNexacroN_SetupRuntime_x64.exe";
...
//이미지 및 아이콘 파일 경로
var strLoadingimage 	= strServerPath + "nexacroN_ins/img/loading_img.gif";   
var strSplashimage 		= strServerPath + "nexacroN_ins/img/loading_img.gif";
var strWallpapericon 	= strServerPath + "nexacroN_ins/img/xicon2.ico";  


/***** 프로젝트 속성 정보 *****/
//project key value
var strKey = "edupack_nexacro_tobe"; //중복나지 않게 키를 적어야 됩니다.
  
//프로젝트 부트스트랩(start.json) 파일 경로
var strBjson = strServerPath + "edupack_nexacro/_windows_/start.json";
...
var strSetupResourcePath = strServerPath + "nexacroN_ins/engine";

 
//Component 경로 (%USERAPP% = C:\Documents and Settings\[UserName]\Local Settings\Application Data\TOBESOFT\Nexacro N\21)
...
var jsonDebugMode = {debug:true,loglevel:"debug"}; //디버깅이 다 끝났으면 debug - false
