(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static02","10","69","100","737",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Grid");
            ...
            obj = new Static("Static03","109","69","904","737",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("");
            ...
            obj = new Grid("grd_list","170","579","700","199",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_binddataset("ds_corp");
            obj.set_scrolltype("none");
            obj.set_autofittype("col");
            obj.set_selecttype("multirow");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"30\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\"/></Rows><Band id=\"head\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"법인코드\"/><Cell col=\"2\" text=\"법인명\"/><Cell col=\"3\" text=\"법인 대표자\"/><Cell col=\"4\" text=\"사원수\"/><Cell col=\"5\" text=\"부서\"/></Band><Band id=\"body\"><Cell text=\"bind:COL_CHK\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"bind:CORP_CODE\" textAlign=\"center\" suppress=\"1\" suppressalign=\"middle\"/><Cell col=\"2\" text=\"bind:CORP_NAME\" textAlign=\"center\" suppress=\"2\" suppressalign=\"middle\"/><Cell col=\"3\" text=\"bind:CORP_CEO\" textAlign=\"center\" suppress=\"3\" suppressalign=\"middle\"/><Cell col=\"4\" text=\"bind:CORP_EMP_NUM\" textAlign=\"center\" suppress=\"4\" suppressalign=\"middle\"/><Cell col=\"5\" text=\"bind:CORP_DEPT_CD\" textAlign=\"center\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("sta00_01_00_01_00","156","608","9","28",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_cssclass("sta_WF_GLineV");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("sta02_01_00_01","126","615","29","14",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("H 28");
            obj.set_cssclass("sta_WF_GTxt");
            this.addChild(obj.name, obj);

            obj = new Static("sta00_01_00_01_00_00","156","579","9","30",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_cssclass("sta_WF_GLineV");
            this.addChild(obj.name, obj);

            obj = new Static("sta02_01_00_01_00","126","588","29","14",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("H 30");
            obj.set_cssclass("sta_WF_GTxt");
            this.addChild(obj.name, obj);

            obj = new Grid("grd_list00","170","120","700","151",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_binddataset("ds_emp_copy");
            obj.set_scrolltype("none");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"83\"/><Column size=\"120\"/><Column size=\"87\"/><Column size=\"120\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/><Row size=\"30\" band=\"summ\"/></Rows><Band id=\"head\"><Cell text=\"법인\"/><Cell col=\"1\" text=\"부서\"/><Cell col=\"2\" text=\"성명\"/><Cell col=\"3\" text=\"사원번호\"/><Cell col=\"4\" text=\"입사일자\"/></Band><Band id=\"body\"><Cell text=\"bind:CORP_CODE\" combodataset=\"ds_corp\" combocodecol=\"CORP_CODE\" combodatacol=\"CORP_NAME\" displaytype=\"combotext\" textAlign=\"center\"/><Cell col=\"1\" text=\"bind:DEPT_CODE\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:FULL_NAME\" edittype=\"text\" textAlign=\"center\"/><Cell col=\"3\" text=\"bind:EMPL_ID\" edittype=\"mask\" maskeditformat=\"AA-###\" maskedittype=\"string\" textAlign=\"center\"/><Cell col=\"4\" text=\"bind:HIRE_DATE\" displaytype=\"date\" edittype=\"date\" calendarpopupsize=\"156 179\"/></Band><Band id=\"summary\"><Cell text=\"Total\"/><Cell col=\"1\"/><Cell col=\"2\"/><Cell col=\"3\"/><Cell col=\"4\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("sta00_01_00_01_00_01","156","149","9","30",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_cssclass("sta_WF_GLineV");
            this.addChild(obj.name, obj);

            obj = new Static("sta02_01_00_01_01","126","161","29","14",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("H 30");
            obj.set_cssclass("sta_WF_GTxt");
            this.addChild(obj.name, obj);

            obj = new Static("sta00_01_00_01_00_00_00","156","120","9","30",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_GLineV");
            this.addChild(obj.name, obj);

            obj = new Static("sta02_01_00_01_00_00","126","129","29","14",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("H 30");
            obj.set_cssclass("sta_WF_GTxt");
            this.addChild(obj.name, obj);

            obj = new Static("sta00_01_00_01_00_01_00","156","241","9","30",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_cssclass("sta_WF_GLineV");
            this.addChild(obj.name, obj);

            obj = new Static("sta02_01_00_01_01_00","126","249","29","14",null,null,null,null,null,null,this);
            obj.set_taborder("15");
            obj.set_text("H 30");
            obj.set_cssclass("sta_WF_GTxt");
            this.addChild(obj.name, obj);

            obj = new Grid("grd00","170","351","700","149",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_binddataset("dsListTab4");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"167\"/><Column size=\"70\"/><Column size=\"70\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"28\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"업무명\"/><Cell col=\"1\" colspan=\"2\" text=\"참여기간\"/><Cell col=\"3\" rowspan=\"2\" text=\"고객사\"/><Cell col=\"4\" rowspan=\"2\" text=\"근무회사\"/><Cell col=\"5\" rowspan=\"2\" text=\"역할\"/><Cell row=\"1\" col=\"1\" text=\"FROM_DT\"/><Cell row=\"1\" col=\"2\" text=\"TO_DT\"/></Band><Band id=\"body\"><Cell text=\"bind:TASK\"/><Cell col=\"1\" text=\"bind:FROM_DT\"/><Cell col=\"2\" text=\"bind:TO_DT\"/><Cell col=\"3\" text=\"bind:CUSTOMER_NAME\"/><Cell col=\"4\" text=\"bind:COMPANY\"/><Cell col=\"5\" text=\"bind:POSITION\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("sta02_01_00_01_00_01","126","420","29","14",null,null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("H 30");
            obj.set_cssclass("sta_WF_GTxt");
            this.addChild(obj.name, obj);

            obj = new Static("sta00_01_00_01_00_00_01","156","411","9","30",null,null,null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_cssclass("sta_WF_GLineV");
            this.addChild(obj.name, obj);

            obj = new Static("sta02_01_00_01_02","340","389","29","14",null,null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_text("H 28");
            obj.set_cssclass("sta_WF_GTxt");
            this.addChild(obj.name, obj);

            obj = new Static("sta00_01_00_01_00_02","370","381","9","28",null,null,null,null,null,null,this);
            obj.set_taborder("20");
            obj.set_cssclass("sta_WF_GLineV");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta00_01_01_00","120","311","190","30",null,null,null,null,null,null,this);
            obj.set_taborder("22");
            obj.set_text("[head 가 2줄 이상인 경우]");
            this.addChild(obj.name, obj);

            obj = new Static("sta00_01_01_00_00","120","539","270","30",null,null,null,null,null,null,this);
            obj.set_taborder("23");
            obj.set_text("[body에 suppress 기능을 사용할 경우]");
            this.addChild(obj.name, obj);

            obj = new Static("sta01_01_00_01","10","0","550","35",null,null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_text("컴포넌트 가이드 03");
            obj.set_cssclass("sta_WF_TitleMain");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1033,816,this,function(p){});
        ...
        {
            this.ds_emp_copy.addEventHandler("oncolumnchanged",this.ds_emp_oncolumnchanged,this);
            this.ds_emp_copy.addEventHandler("cancolumnchange",this.ds_emp_cancolumnchange,this);
        };
