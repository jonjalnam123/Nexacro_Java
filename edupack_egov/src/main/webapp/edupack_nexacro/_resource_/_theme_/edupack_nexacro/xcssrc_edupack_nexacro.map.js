            												...
            												"Grid" :
            												{
            													"self" :
            													{
            														"enabled" :
            														{
            															...
            															"font" : nexacro.FontObject("bold italic 14px/normal \"Arial\"")
            														}
            													}
            												}
            											}
            											...
            											"parent" :
            											{
            												"Grid" :
            												{
            													"self" :
            													{
            														"enabled" :
            														{
            															"border" : nexacro.BorderObject("1px solid #d8d9da,0px none,1px solid #d8d9da,1px solid #d8d9da")
            														}
            													}
            												}
            											}
            											...
            											"parent" :
            											{
            												"Grid" :
            												{
            													"self" :
            													{
            														"enabled" :
            														{
            															"color" : nexacro.ColorObject("#c2c7d0"),
            															"font" : nexacro.FontObject("bold 14px \"Malgun Gothic\",\"Verdana\"")
            														}
            													}
            												}
            												...
            												"grd_MT_mnuPop" :
            												{
            													"self" :
            													{
            														"enabled" :
            														{
            															...
            															"font" : nexacro.FontObject("normal 18px \"Malgun Gothic\""),
            														...
            														"selected" :
            														{
            															"color" : nexacro.ColorObject("#546169"),
            															"font" : nexacro.FontObject("normal 18px \"Malgun Gothic\""),
            															"padding" : nexacro.PaddingObject("2px"),
            															"border" : nexacro.BorderObject("0px none , 0px none , 1px solid #cbcbcb , 0px none")
            														}
            				...
            				[
            					{
            						"grd_MT_mnuPop" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("2px solid #b42854,0px none,0px none,0px none")
            								}
            							}
            						}
            					}
            					...
            					},
            					{
            						"sta_WF_msgRed" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("11px/normal \"Verdana\",\"Malgun Gothic\""),
            									"color" : nexacro.ColorObject("red")
            								}
            							}
            						}
            				...
            				[
            					{
            						"txt_WF_Desc" :
            						{
            							"self" :
            							{
            								...
            								"readonly" :
            								{
            									"font" : nexacro.FontObject("13px/24px \" Verdana\",\"Malgun Gothic\""),
            									"letterSpacing" : nexacro.CSSValueObject("1px"),
            									"border" : nexacro.BorderObject("1px solid #c4c4c4")
            								}
            							}
