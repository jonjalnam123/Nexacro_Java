(function()
{
	return function()
	{
            					...
            					},
            					{
            						"sta_Right" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none,0px none,0px none,1px solid #d3dce1")
            								}
            							}
            						}
            					},
            						...
            						"sta_TF_PushCount" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"color" : nexacro.ColorObject("#ffffff"),
            									"font" : nexacro.FontObject("10px/normal \"Verdana\",\"Malgun Gothic\"")
            								}
            							}
            						}
            					},
            					...
            					},
            					{
            						"sta_POP_Contents" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"font" : nexacro.FontObject("14px/26px \"Verdana\",\"Malgun Gothic\""),
            					...
            					},
            					{
            						"edt_LOGIN_ID" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"padding" : nexacro.PaddingObject("1px 0px 0px 50px"),
            									"font" : nexacro.FontObject("16px \"Verdana\",\"Malgun Gothic\"")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none,0px none, 1px solid #a3bbc1")
            								},
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("0px none,0px none, 1px solid #a3bbc1")
            				...
            				[
            					{
            						"btn_TF_Logout" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("0px none, 0px none, 0px none, 1px solid #7aaed9"),
            									"color" : nexacro.ColorObject("#ffffff"),
            									"font" : nexacro.FontObject("bold 12px \"Verdana\",\"Malgun Gothic\"")
            								},
            								"focused" :
            					...
            					},
            					{
            						"btn_LF_Change" :
            						{
            							"self" :
            							{
            								...
            								{
            									"border" : nexacro.BorderObject("0px none"),
            									"icon" : nexacro.UrlObject("URL(\"theme://images/img_LF_Change.png\")")
            								},
            								"mouseover" :
            								{
            									"border" : nexacro.BorderObject("0px none"),
            					...
            					},
            					{
            						"btn_LF_MenuIcon" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #dbdde7"),
            								...
            								"focused" :
            								{
            									"border" : nexacro.BorderObject("1px solid #dbdde7,1px solid #dbdde7,0px none"),
            									"icon" : nexacro.UrlObject("url('theme://images/img_LF_Menu.png')"),
            									"iconPosition" : "left",
            									"padding" : nexacro.PaddingObject("0px 0px 0px 6px"),
            									"textPadding" : nexacro.PaddingObject("0px 0px 0px 8px")
            					...
            					},
            					{
            						"btn_LOGIN_Login" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"border" : nexacro.BorderObject("1px solid #f5a11d"),
            									"color" : nexacro.ColorObject("#ffffff"),
            									"font" : nexacro.FontObject("bold 16px/normal \"Verdana\",\"Malgun Gothic\""),
            									"letterSpacing" : nexacro.CSSValueObject("-1px")
            								},
            								"disabled" :
            								{
            						...
            						"btn_POP_Cancel" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									...
            									"color" : nexacro.ColorObject("#0c064b"),
            					...
            					},
            					{
            						"chk_LOGIN_Remember" :
            						{
            							"self" :
            							{
            								"enabled" :
            								{
            									"icon" : nexacro.UrlObject("url('theme://images/chk_LOGIN_Remember.png')"),
            									"color" : nexacro.ColorObject("#08497f")
            								},
            								"disabled" :
            								{
            									"icon" : nexacro.UrlObject("url('theme://images/chk_LOGIN_RememberS.png')"),
            									"color" : nexacro.ColorObject("#08497f")
            								},
            								"mouseover" :
            								{
            						...
            						[
            							{
            								"tab_MDI_Menu" :
            								{
            									"self" :
            									{
            										...
            										"mouseover" :
            										{
            											"border" : nexacro.BorderObject("1px solid #d3dce1,1px solid #d3dce1,0px none"),
            											"color" : nexacro.ColorObject("#0e63a9")
            										},
            										"selected" :
            										{
            											"border" : nexacro.BorderObject("1px solid #d3dce1,1px solid #d3dce1,0px none"),
        ...
        imgcache[nexacro._getImageLocation("theme://images/btn_TF_MaxP.png")] = { width:11, height:11 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/img_TF_PushN.png")] = { width:24, height:24 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/sta_LF_IconN.png")] = { width:29, height:27 };
        		imgcache[nexacro._getImageLocation("theme://images/img_LF_Find.png")] = { width:16, height:16 };
        		imgcache[nexacro._getImageLocation("theme://images/img_LF_Change.png")] = { width:16, height:16 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/img_LOGIN_ID.png")] = { width:16, height:16 };
        		imgcache[nexacro._getImageLocation("theme://images/img_LOGIN_PW.png")] = { width:15, height:20 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/sta_POP_Error.png")] = { width:89, height:88 };
        		imgcache[nexacro._getImageLocation("theme://images/sta_POP_Information.png")] = { width:89, height:88 };
        		imgcache[nexacro._getImageLocation("theme://images/sta_POP_Question.png")] = { width:89, height:88 };
        		imgcache[nexacro._getImageLocation("theme://images/sta_POP_Warning.png")] = { width:93, height:90 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/chk_LOGIN_Remember.png")] = { width:15, height:15 };
        		imgcache[nexacro._getImageLocation("theme://images/chk_LOGIN_RememberS.png")] = { width:15, height:15 };
        		...
        		imgcache[nexacro._getImageLocation("theme://images/img_Login_Logo.png")] = { width:244, height:156 };
        		imgcache[nexacro._getImageLocation("theme://images/img_MainBg.png")] = { width:1500, height:679 };
        		imgcache[nexacro._getImageLocation("theme://images/img_TF_FrameDown.png")] = { width:16, height:16 };
        		imgcache[nexacro._getImageLocation("theme://images/img_TF_FrameUp.png")] = { width:16, height:16 };
