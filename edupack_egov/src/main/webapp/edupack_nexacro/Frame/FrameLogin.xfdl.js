(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divLogin","439","199","400","500",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("");
            obj.set_background("#f3f5f6");
            obj.set_formscrollbartype("none none");
            this.addChild(obj.name, obj);

            obj = new Edit("edId","33","199","335","50",null,null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("0");
            obj.set_cssclass("edt_LOGIN_ID");
            obj.set_font("normal 16px/normal \"Verdana,Malgun Gothic\"");
            obj.set_text("Admin");
            this.divLogin.addChild(obj.name, obj);

            obj = new Edit("edPw","33","269","335","50",null,null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("1");
            ...
            obj = new Combo("cboLang","33","520","220","41",null,null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("2");
            ...
            obj = new Button("btnLogin","33","369","335","50",null,null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("3");
            obj.set_text("로그인");
            ...
            obj = new Static("sta00","-12","5","404","156",null,null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("4");
            obj.set_cssclass("sta_LOGIN_Logo");
            this.divLogin.addChild(obj.name, obj);

            obj = new CheckBox("chk00","34","342","150","20",null,null,null,null,null,null,this.divLogin.form);
            obj.set_taborder("5");
            obj.set_text("아이디 기억하기");
            obj.set_cssclass("chk_LOGIN_Remember");
            this.divLogin.addChild(obj.name, obj);

            obj = new Button("btn00","921","418","131","59",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("btn00");
            this.addChild(obj.name, obj);
            // Layout Functions
        ...
        */
        ...
        {
        	var sRtn = nexacro.getEnvironmentVariable("en_val");
        	alert("en_val = " + sRtn);

        	var objApp = nexacro.getApplication();
        	alert("application = " + objApp.app_val);
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.divLogin.form.sta00.addEventHandler("onclick",this.divLogin_sta00_onclick,this);
