(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btn00","492","12","120","21",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("btn00");
            this.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("SampleTransaction_copy0.xfdl", function() {
        /**
        ...
        */
        ...
        {
         	var strSvcId    = "search";
        	var strSvcUrl   = "transactionSelectVoList.do";
        	var inData      = "dsSearch=dsSearch";
        	var outData     = "dsList=dsList";
        	var strArg      = "NAME=" + this.gfnNvl(this.divSearch.form.edtName.value,"");
        	var callBackFnc = "fnCallback";
        ...
        */
        ...
        this.loadIncludeScript("SampleTransaction_copy0.xfdl");
