(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("Div00","10","172","496","350",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_url("Cmm::CmmRmateChartAll.xfdl");
            obj.set_cssclass("div_WF_Area");
            this.addChild(obj.name, obj);

            obj = new Div("Div01","515","172","496","350",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_url("Cmm::CmmRmateChartAll.xfdl");
            obj.set_cssclass("div_WF_Area");
            this.addChild(obj.name, obj);

            obj = new Div("Div02","10","592","496","350",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_url("Cmm::CmmRmateChartAll.xfdl");
            obj.set_cssclass("div_WF_Area");
            this.addChild(obj.name, obj);

            obj = new Div("Div03","515","592","496","350",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_url("Cmm::CmmRmateChartAll.xfdl");
            obj.set_cssclass("div_WF_Area");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta03","10","35",null,"90","10",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("브라우져에 따라 rMateChart를 실행 한다.\r\n   웹브라우져 - Div 컴포넌트에 직접 rMateChart를 실행.\r\n   넥사크로브라우져 : 웹 브라우져로 rMateChart를 실행.");
            obj.set_cssclass("sta_WF_Desc");
            this.addChild(obj.name, obj);

            obj = new Static("Static00","10","132","178","28",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("1) Line ");
            ...
            obj = new Static("Static01","515","132","178","28",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("2) Bar");
            obj.set_cssclass("sta_WF_TitleType1");
            this.addChild(obj.name, obj);

            obj = new Static("Static02","10","552","178","28",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("3) Column");
            obj.set_cssclass("sta_WF_TitleType1");
            this.addChild(obj.name, obj);

            obj = new Static("Static03","515","552","178","28",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("4) Pie");
            obj.set_cssclass("sta_WF_TitleType1");
            this.addChild(obj.name, obj);

            obj = new Button("btnChangData","899","557","110","28",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("Data 변경");
            this.addChild(obj.name, obj);

            obj = new Button("btnChangLayout","784","557","110","28",null,null,null,null,null,null,this);
            obj.set_taborder("11");
