(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new WebView("webEditor","10","85","528","450",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.registerScript("SampleNaverEditor_WebView.xfdl", function() {
        /**
        ...
        */
        ...
        this.loadIncludeScript("SampleNaverEditor_WebView.xfdl");
