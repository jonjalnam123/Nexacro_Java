(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnLine","10","94","80","28",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("Line");
            this.addChild(obj.name, obj);

            obj = new Button("btnBar","95","94","80","28",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("Bar");
            this.addChild(obj.name, obj);

            obj = new Button("btnPie","265","94","80","28",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Pie");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid00",null,"132","240",null,"10","30",null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new Button("btnLine00","370","94","120","28",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("Line - Multi");
            this.addChild(obj.name, obj);

            obj = new Button("btnBar00","495","94","120","28",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("Bar - Multi");
            this.addChild(obj.name, obj);

            obj = new Button("btnColumn","180","94","80","28",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("Column");
            this.addChild(obj.name, obj);

            obj = new Button("btnColumn00","620","94","120","28",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("Column - Multi");
            this.addChild(obj.name, obj);

            obj = new Button("btnCombination","765","94","230","28",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("Combination(Column+Line) ");
            this.addChild(obj.name, obj);

            obj = new Div("div00","10","132",null,null,"258","30",null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("div00");
            ...
            obj = new Static("sta02","10","0","251","35",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("rMate 챠트(웹브라우져 방식)");
            obj.set_cssclass("sta_WF_TitleMain");
            this.addChild(obj.name, obj);

            obj = new Static("sta03","10","35",null,"40","10",null,"980",null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("rMate Chart 연동 샘플이다.");
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.div00.form.div00.form.webChart.addEventHandler("onusernotify",this.div00_div00_webChart_onusernotify,this);
        };
