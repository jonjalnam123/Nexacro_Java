(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("div_calFromTo","87","10","290","30",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("3");
            obj.set_text("div00");
            ...
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this.div_search.form.div_calFromTo
            obj = new Layout("default","",0,0,this.div_search.form.div_calFromTo.form,function(p){});
            this.div_search.form.div_calFromTo.form.addLayout(obj.name, obj);
        ...
        // User Script
        this.registerScript("Form_EduScriptSample3.xfdl", function() {
        ...
        this.Form_onload = function(obj,e)
        {
        	...
        	this.div_search.form.div_calFromTo.form.fnSetFromDate(this.gfnGetFirstDate());
        	this.div_search.form.div_calFromTo.form.fnSetToDate(this.gfnGetDate());

            var arrCode = new Array();
        	arrCode.push({codeGroup:"C001", obj:this.div_search.form.rdo_gender, first:"0"});
        	arrCode.push({codeGroup:"A001", obj:this.ds_pos});
            this.gfnGetCommonCode(arrCode);
        	this.div_search.form.rdo_gender.set_value("ALL");
        ...
        this.btn_del_onclick = function(obj,e)
        {
            ...
            var arrArg = "";
            var strPopId = "popMsgDelete";
            var strCallback = "fn_msgCallback";
            this.gfnAlert(strMsgId, arrArg, strPopId, strCallback);
        };

        this.fn_msgCallback = function(strId, strVal)
        {
        	if(strId == "popMsgDelete"){
        		if(strVal){
        ...
        this.loadIncludeScript("Form_EduScriptSample3.xfdl");
