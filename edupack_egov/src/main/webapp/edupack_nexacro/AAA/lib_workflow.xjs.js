...
(function()
{
    return function(path)
    {
        ...
        * @return             : 없음
        */
        this.gfnDrawWorkFlow = function(objGraphics, pvConfig)
        {
        	var i, nRow;
        	var dsItems;
        	var dsLines;
        	...
        	if(pvConfig)objGraphics.config = pvConfig;
        	...
        	//노드 데이터셋 가져오기
        	dsItems = objConfig.itemsDs;

        	//연결선 데이터셋 가져오기
        	dsLines = objConfig.linesDs;
        ...
        */
        this.gfnDrawGraphicPath = function(objGraphics, objLine)
        {
        	...
        	//시작 노드 ID
        	sFrom = "node_"+objLine.from;

        	//종료 노드 ID
        	sTo = "node_"+objLine.to;
        	...
        	//시작 노드 가져오기
        	objFromPath = objGraphics.getObjectByID(sFrom);
        	...
        	objToPath = objGraphics.getObjectByID(sTo);
