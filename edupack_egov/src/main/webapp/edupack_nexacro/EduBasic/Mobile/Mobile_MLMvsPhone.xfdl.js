(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("MLM DeskTop VS Phone");
            ...
            obj = new Layout("Layout0","",0,0,this.div_detail.form,
                ...
                var rootobj = p;
                p = rootobj;
                p.Static02.move("159","0","299","50",null,null);

                p.Static01.move("159","49","299","50",null,null);

                p.Static09.move("159","98","299","50",null,null);

                p.Static15.move("159","147","299","134",null,null);

                p.Static17.move("159","280","299","50",null,null);

                p.Static13.move("159","329","299","50",null,null);

                p.Static20.move("159","378","299","50",null,null);

                p.Static04.move("159","427","299","50",null,null);

                p.Static07.move("159","476","299","90",null,null);

                p.edt_name.move("165","5","287","40",null,null);

                p.msk_id.move("165","54","287","40",null,null);

                p.cbo_dept.set_scrollbardecbuttonsize("0");
                p.cbo_dept.set_scrollbarincbuttonsize("0");
                p.cbo_dept.set_popuptype("center");
                p.cbo_dept.move("165","103","287","40",null,null);

                p.lst_pos.set_scrollbardecbuttonsize("0");
                p.lst_pos.set_scrollbarincbuttonsize("0");
                p.lst_pos.move("165","153","287","122",null,null);

                p.rdo_gender.move("165","285","287","40",null,null);

                p.chk_married.set_text("Married");
                p.chk_married.move("165","334","287","40",null,null);
                ...
                p.cal_date.move("165","383","287","40",null,null);

                p.txt_memo.move("165","482","287","78",null,null);

                p.msk_salary.move("165","432","287","40",null,null);

                p.Static08.move("0","98","160","50",null,null);

                p.Static10.move("0","0","160","50",null,null);

                p.Static12.move("0","378","160","50",null,null);

                p.Static14.move("0","147","160","134",null,null);

                p.Static16.move("0","280","160","50",null,null);

                p.Static19.move("0","427","160","50",null,null);

                p.Static00.move("0","49","160","50",null,null);

                p.Static03.move("0","329","160","50",null,null);

                p.Static05.move("0","476","160","90",null,null);
            	}
            );
            this.div_detail.form.addLayout(obj.name, obj);
            //-- Default Layout : this
            obj = new Layout("default","screen_desktop",800,600,this,
                ...
                var rootobj = p;
                p = rootobj;
                p.set_titletext("MLM DeskTop VS Phone");
            ...
            obj = new Layout("Layout0","screen_phone",480,768,this,
                ...
                p.div_detail.move("10","70",null,null,"10","35");
                ...
                p.grd_list.move("10","70",null,null,"10","35");

                p.st_title.set_positionstep("-1");
                p.st_title.set_cssclass("sta_MBF_subtitle");
                p.st_title.move("10","10","193","50",null,null);

                p.btn_add.set_positionstep("-1");
                p.btn_add.move(null,"10","100","50","111",null);

                p.btn_del.set_positionstep("-1");
                p.btn_del.move(null,"10","97","50","10",null);
            	}
            );
