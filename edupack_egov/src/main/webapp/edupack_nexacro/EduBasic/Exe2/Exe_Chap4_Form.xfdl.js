(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static06","70","78","250","43",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Static("Static04","10","160","110","20",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("Exe2");
            obj.set_cssclass("sta_WF_TypeTitle");
            this.addChild(obj.name, obj);
        ...
        this.btn_Exe3_1_onclick = function(obj,e)
        {
        	...
        	objChildFrame.init("chf_popup1"
        					  ...
        					  , null
        					  , null
        					  , "EduBasic::Exe/Exe_Chap4_Form_Popup.xfdl");
        ...
        this.btn_Exe3_3_onclick = function(obj,e)
        {
        	...
        	nexacro.open("chf_popup2"
        	           , "Exe::Exe/Exe_Chap4_Form_Popup.xfdl"
        			   , this.getOwnerFrame()
        			   , objParam
        			   , sOpenStyle
        			   , nLeft
