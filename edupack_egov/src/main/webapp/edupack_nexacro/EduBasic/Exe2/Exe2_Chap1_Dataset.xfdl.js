(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("Exe2_Chap1_Dataset.xfdl", function() {
        // Exercise 1 ================================================================
        // Exe 1-1
        ...
        this.btn_Exe3_Filter_onclick = function(obj,e)
        {
        	...
        	// 조건값에 '이 포함되어 있는 경우 오류가 발생할 수 있습니다.
        	// 컬럼 Type이 String이 아닌 경우를 대비하여 String으로 감싸줍니다.
        	// var sText = "e";
        ...
        this.btn_Exe5_1_onclick = function(obj,e)
        {
        	...
        	this.Grid5.setRealRowSize(-1, 30);
        	this.Grid5.setRealRowSize(0, 30);
        };
        ...
        this.loadIncludeScript("Exe2_Chap1_Dataset.xfdl");
