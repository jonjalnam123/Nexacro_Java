(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("Grid4","10","70",null,null,"10","53",null,null,null,null,this);
            obj.set_taborder("21");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"251\"/><Column size=\"159\"/><Column size=\"80\"/><Column size=\"131\"/><Column size=\"200\"/></Columns><Rows><Row size=\"32\" band=\"head\"/><Row size=\"32\"/></Rows><Band id=\"head\"><Cell text=\"ORG_NAME\"/><Cell col=\"1\" text=\"POSITION\"/><Cell col=\"2\" text=\"GENDER\"/><Cell col=\"3\" text=\"PHONE_NO\"/><Cell col=\"4\" text=\"E_MAIL\"/></Band><Band id=\"body\"><Cell text=\"bind:ORG_NAME\" displaytype=\"treeitemcontrol\" edittype=\"tree\" treelevel=\"bind:LEVEL\" treecheck=\"bind:COL_CHK\"/><Cell col=\"1\" text=\"bind:POSITION\"/><Cell col=\"2\" text=\"bind:GENDER\"/><Cell col=\"3\" text=\"bind:PHONE_NO\"/><Cell col=\"4\" text=\"bind:E_MAIL\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static07_00_00","10","40","380","30",null,null,null,null,null,null,this);
            obj.set_taborder("63");
            ...
            obj = new Static("Static06_00","10","0","250","30",null,null,null,null,null,null,this);
            obj.set_taborder("61");
        ...
        // User Script
        this.registerScript("Exe2_Chap2_Grid.xfdl", function() {
        // Exercise 1 ================================================================
        // Exe 1-1
        ...
        {
        // 	var sColId = this.Grid1.getCellProperty("body", e.cell, "text").split(":");
        // 	this.Dataset1.set_keystring("S:+" + sColId[1]);
        ...
        this.Dataset2_oncolumnchanged = function(obj,e)
        {
        	if(e.columnid == "COL_CHK"){
        		var nRow = this.Dataset2.findRowExpr("COL_CHK == '" + e.newvalue + "' && currow != " + e.row)
                trace(nRow);
        		if(nRow > -1){
                    this.Dataset2.setColumn(nRow, "COL_CHK", "0");
        		}
        	}
        };
        ...
        {
        	var nCol  = e.col;
        	var nSize = obj.getRealColSize(e.col);
        	this.Grid3.arrHide.unshift({size:nSize, col:nCol});

        	this.Grid3.setFormatColProperty(e.col, "size", 0);
        };

        // Exe 3 Hide Cancel
        this.btn_Cancel_onclick = function(obj,e)
        {
        	var nCol  = this.Grid3.arrHide[0].col;
        	var nSize = this.Grid3.arrHide[0].size;
        	this.Grid3.setFormatColProperty(nCol, "size", nSize);

        	this.Grid3.arrHide.shift();
        };
        ...
        this.loadIncludeScript("Exe2_Chap2_Grid.xfdl");
