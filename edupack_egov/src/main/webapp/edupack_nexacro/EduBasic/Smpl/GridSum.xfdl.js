(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("Grid00","10","40",null,null,"10","10",null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_binddataset("ds_sum");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"133\"/><Column size=\"138\"/><Column size=\"109\"/><Column size=\"159\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"법인명\"/><Cell col=\"1\" text=\"부서명\"/><Cell col=\"2\" text=\"성명\"/><Cell col=\"3\" text=\"연봉\"/></Band><Band id=\"body\"><Cell text=\"bind:CORP\" suppress=\"1\" suppressalign=\"middle\"/><Cell col=\"1\" text=\"bind:DEPT\" suppress=\"3\"/><Cell col=\"2\" text=\"bind:NAME\"/><Cell col=\"3\" text=\"bind:SALARY\" textAlign=\"right\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("Button00",null,"0","60","28","273",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("SUM");
            this.addChild(obj.name, obj);

            obj = new Button("Button01",null,"0","60","28","208",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("AVG");
            this.addChild(obj.name, obj);

            obj = new Button("Button02",null,"0","60","28","143",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("MAX");
            this.addChild(obj.name, obj);

            obj = new Button("Button03",null,"0","60","28","78",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("MIN");
            this.addChild(obj.name, obj);

            obj = new Button("Button04",null,"0","60","28","13",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("COUNT");
            this.addChild(obj.name, obj);
