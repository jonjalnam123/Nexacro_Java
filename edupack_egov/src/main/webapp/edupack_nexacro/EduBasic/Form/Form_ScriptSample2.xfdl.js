(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"44\"/><Column size=\"77\"/><Column size=\"151\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"No\"/><Cell col=\"1\" text=\"부서코드\"/><Cell col=\"2\" text=\"부서명\"/></Band><Band id=\"body\"><Cell text=\"expr:currow+1\" textAlign=\"center\"/><Cell col=\"1\" text=\"bind:DEPT_CD\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:DEPT_NAME\" textAlign=\"center\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
        ...
        this.executeIncludeScript("Lib::Lib_Util.xjs"); /*include "Lib::Lib_Util.xjs"*/; //Lib 폴더에 있는 xjs 파일을 연결 해 줌
        ...
        this.Form_onload = function(obj,e)
        {
            ...
            var sInDs     = "";
            var sOutDs    = "ds_pos=out_pos ds_dept=out_dept ds_gender=out_gender";
            var sParam    = "";
        ...
        this.fn_selectEmp = function()
        {
            ...
            var sCallBack = "fn_callback";
        	this.lfn_transaction(sSvcID, sURL, sInDs, sOutDs, sParam, sCallBack, true);
        }
        ...
        this.fn_callback = function(svcID, errCD, errMSG)
        {
        	...
        	var sMsg = this.lfn_getMsg("msg.save.success");
        		this.alert(sMsg);
        	}
