(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("edt_dept_nm","236","8","144","28",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("2");
            this.div_search.addChild(obj.name, obj);

            obj = new Radio("rdo_gender","498","8","252","28",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("3");
            ...
            obj = new Static("Static04","430","8","68","28",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("4");
            obj.set_text("성별");
            obj.set_cssclass("sta_WF_TitleSearch");
            this.div_search.addChild(obj.name, obj);
            ...
            obj = new Button("btn_retrieve",null,"4","63","26","214",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("조회");
            obj.set_cssclass("btn_WF_CRUD");
            this.addChild(obj.name, obj);

            obj = new Button("btn_add",null,"4","63","26","146",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("입력");
            obj.set_cssclass("btn_WF_CRUD");
            this.addChild(obj.name, obj);

            obj = new Button("btn_del",null,"4","63","26","78",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("삭제");
            obj.set_cssclass("btn_WF_CRUD");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("grd_list","10","111",null,null,"400","38",null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new Div("div_detail",null,"111","380",null,"10","38",null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("Div00");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static17","137","356","243","145",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("20");
            obj.set_text("");
            obj.set_background("");
            obj.set_padding("");
            ...
            obj = new TextArea("txt_memo","147","361","226","135",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("9");
            this.div_detail.addChild(obj.name, obj);
            ...
            obj = new Static("Static05","0","356","140","145",null,null,null,null,null,null,this.div_detail.form);
            obj.set_taborder("25");
            obj.set_text("비고사항");
            obj.set_background("");
            obj.set_padding("");
            ...
            obj = new Static("sta00_00","10","81","196","30",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("사원목록");
            obj.set_cssclass("sta_WF_TitleSub");
            this.addChild(obj.name, obj);

            obj = new Static("sta00_00_00","grd_list:10","81","196","30",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("상세정보");
            obj.set_cssclass("sta_WF_TitleSub");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("Form_Emp_copy0.xfdl", function() {
        ...
        this.loadIncludeScript("Form_Emp_copy0.xfdl");
