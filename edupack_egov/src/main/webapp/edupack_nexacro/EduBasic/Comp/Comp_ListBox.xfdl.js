(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("Component-ListBox");
            ...
            obj = new Static("Static04","10","40","290","28",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text(" Basic Usage - innerdataset");
            obj.set_cssclass("sta_WF_TitleType1");
            this.addChild(obj.name, obj);

            obj = new ListBox("ListBox00","20","73","210","130",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new ListBox("ListBox02","20","261","210","160",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            obj = new Static("Static03","12","228","306","28",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text(" Multi Select (Prop. multiselect)");
            obj.set_cssclass("sta_WF_TitleType1");
            this.addChild(obj.name, obj);

            obj = new Button("Button00","240","261","146","28",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("Get Selected List");
            this.addChild(obj.name, obj);

            obj = new ListBox("ListBox03","240","73","230","130",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new ListBox("ListBox01","20","479","210","120",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_multiselect("true");
            ...
            obj = new Static("Static00","12","446","306","28",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text(" Item Height (Prop. itemheight)");
            obj.set_cssclass("sta_WF_TitleType1");
            this.addChild(obj.name, obj);

            obj = new TextArea("txt_rtn","240","294","210","128",null,null,null,null,null,null,this);
            obj.set_taborder("4");
