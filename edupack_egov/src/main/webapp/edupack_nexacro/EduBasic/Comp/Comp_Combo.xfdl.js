(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("Static04","10","40","260","28",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("Basic Usage - innerdataset");
            obj.set_cssclass("sta_WF_TitleType1");
            this.addChild(obj.name, obj);

            obj = new Radio("Radio00","16","179","460","28",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Combo("cmb_type","18","212","160","28",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new Combo("Combo00","18","73","178","28",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            obj = new Static("Static00","10","146","248","28",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("Combo Type (Prop. type)");
            obj.set_cssclass("sta_WF_TitleType1");
            this.addChild(obj.name, obj);

            obj = new Static("Static01","10","391","318","28",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_text("Null Text (Prop. displaynulltext)");
            obj.set_cssclass("sta_WF_TitleType1");
            this.addChild(obj.name, obj);

            obj = new Combo("Combo03","201","73","178","28",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_codecolumn("DEPT_CD");
            obj.set_datacolumn("DEPT_NAME");
            obj.set_innerdataset("ds_dept");
            ...
            obj = new Combo("cmb_count","97","320","198","28",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_codecolumn("DEPT_CD");
            obj.set_datacolumn("DEPT_NAME");
            obj.set_innerdataset("ds_dept");
            ...
            obj = new Static("Static02","10","285","360","28",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("Display Count (Prop. displayrowcount)");
            obj.set_cssclass("sta_WF_TitleType1");
            this.addChild(obj.name, obj);

            obj = new Spin("spn_count","18","318","74","28",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_min("5");
            obj.set_max("20");
            obj.set_value("5");
            ...
            obj = new Combo("Combo01","18","424","198","28",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
