(function()
{
    return function()
    {
        ...
        {
            this.set_name("Template_ListDetailList");
            this.set_titletext("ListDetail0H");
            ...
            obj = new Grid("grd_list","10","116",null,"524","465",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_binddataset("ds_emp");
            obj.set_scrolltype("none");
            obj.set_autofittype("col");
            obj.set_visible("true");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"108\"/><Column size=\"107\"/><Column size=\"101\"/><Column size=\"120\"/><Column size=\"99\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"법인\"/><Cell col=\"1\" text=\"사원번호\"/><Cell col=\"2\" text=\"성명\"/><Cell col=\"3\" text=\"부서\"/><Cell col=\"4\" text=\"연봉\"/></Band><Band id=\"body\"><Cell text=\"bind:CORP_CODE\" displaytype=\"combotext\" edittype=\"combo\" combodataset=\"ds_corp\" combocodecol=\"CORP_CODE\" combodatacol=\"CORP_NAME\"/><Cell col=\"1\" text=\"bind:EMPL_ID\"/><Cell col=\"2\" text=\"bind:FULL_NAME\"/><Cell col=\"3\" text=\"bind:DEPT_CODE\" displaytype=\"combotext\" combodataset=\"ds_dept\" combocodecol=\"DEPT_CODE\" combodatacol=\"DEPT_NAME\"/><Cell col=\"4\" text=\"bind:SALARY\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Div("Div06","grd_list:10","81",null,"332","10",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_visible("true");
            obj.set_text("");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta_00","119","35","326","38",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("1");
            ...
            obj = new Static("sta_01","119","72","326","38",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("3");
            obj.set_cssclass("sta_WF_DetailArea");
            obj.set_visible("true");
            this.Div06.addChild(obj.name, obj);
            ...
            obj = new Static("sta_02","119","109","326","38",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("5");
            obj.set_cssclass("sta_WF_DetailArea");
            obj.set_visible("true");
            this.Div06.addChild(obj.name, obj);
            ...
            obj = new Combo("cmb_dept","125","40","231","28",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("7");
            ...
            obj = new Edit("edt_name","125","77","231","28",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("8");
            obj.set_visible("true");
            this.Div06.addChild(obj.name, obj);

            obj = new Static("Static03","0","146","120","38",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("16");
            obj.set_text("성별");
            obj.set_cssclass("sta_WF_DetailLabel");
            obj.set_visible("true");
            ...
            obj = new Static("sta_03","119","146","326","38",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("10");
            obj.set_cssclass("sta_WF_DetailArea");
            obj.set_visible("true");
            this.Div06.addChild(obj.name, obj);

            obj = new Static("Static02","0","183","120","38",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("15");
            obj.set_text("부서");
            obj.set_cssclass("sta_WF_DetailLabel");
            obj.set_visible("true");
            ...
            obj = new Static("sta_04","119","183","326","38",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("11");
            obj.set_cssclass("sta_WF_DetailArea");
            obj.set_visible("true");
            this.Div06.addChild(obj.name, obj);

            obj = new Static("Static07","0","220","120","38",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("18");
            obj.set_text("전화번호");
            obj.set_cssclass("sta_WF_DetailLabel");
            obj.set_visible("true");
            ...
            obj = new Static("sta_05","119","220","326","38",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_DetailArea");
            obj.set_visible("true");
            this.Div06.addChild(obj.name, obj);

            obj = new Static("sta_06","119","257","326","38",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("13");
            obj.set_cssclass("sta_WF_DetailArea");
            obj.set_visible("true");
            this.Div06.addChild(obj.name, obj);

            obj = new Static("sta_07","119","294","326","38",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("14");
            obj.set_cssclass("sta_WF_DetailArea");
            obj.set_visible("true");
            this.Div06.addChild(obj.name, obj);

            obj = new Static("Static04","0","257","120","38",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("17");
            obj.set_text("입사일자");
            obj.set_cssclass("sta_WF_DetailLabel");
            obj.set_visible("true");
            ...
            obj = new Static("Static08","0","294","120","38",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("19");
            obj.set_text("이메일");
            obj.set_cssclass("sta_WF_DetailLabel");
            obj.set_visible("true");
            ...
            obj = new MaskEdit("MaskEdit00","125","114","231","28",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("21");
            obj.set_format("AA-###");
            obj.set_type("string");
            obj.set_visible("true");
            ...
            obj = new Calendar("Calendar00","125","262","231","28",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("22");
            obj.set_visible("true");
            this.Div06.addChild(obj.name, obj);

            obj = new Edit("edt_name00","125","225","231","28",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("23");
            obj.set_visible("true");
            this.Div06.addChild(obj.name, obj);

            obj = new Edit("edt_name01","125","299","231","28",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("24");
            obj.set_visible("true");
            this.Div06.addChild(obj.name, obj);

            obj = new Radio("Radio00","125","151","231","28",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("9");
            ...
            obj = new Combo("cmb_dept00","125","188","231","28",null,null,null,null,null,null,this.Div06.form);
            obj.set_taborder("20");
            obj.set_innerdataset("ds_dept");
            obj.set_codecolumn("DEPT_CODE");
            obj.set_datacolumn("DEPT_NAME");
            ...
            obj = new Static("sta00_00","446","8","58","28",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("4");
            obj.set_text("성별");
            obj.set_cssclass("sta_WF_SearchLabel");
            this.div00.addChild(obj.name, obj);

            obj = new Radio("rdo00","504","8","260","28",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("5");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_rowcount("1");
            ...
            obj = new Div("Div00","grd_list:10","412","445","228",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("Div00");
            this.addChild(obj.name, obj);

            obj = new Static("Static09","0","36","120","38",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("0");
            obj.set_text("생년월일");
            obj.set_cssclass("sta_WF_DetailLabel");
            obj.set_visible("true");
            ...
            obj = new Static("sta_08","119","36","326","38",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("1");
            obj.set_cssclass("sta_WF_DetailArea");
            obj.set_visible("true");
            this.Div00.addChild(obj.name, obj);

            obj = new Static("Static11","0","73","120","38",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("2");
            obj.set_text("연봉");
            obj.set_cssclass("sta_WF_DetailLabel");
            obj.set_visible("true");
            ...
            obj = new Static("Static13","6","1","97","35",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("3");
            obj.set_text("부가정보");
            obj.set_cssclass("sta_WF_TitleSub");
            obj.set_visible("true");
            ...
            obj = new Calendar("Calendar01","125","41","231","28",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("4");
            obj.set_visible("true");
            this.Div00.addChild(obj.name, obj);

            obj = new Static("sta_10","119","73","326","38",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("5");
            obj.set_cssclass("sta_WF_DetailArea");
            obj.set_visible("true");
            this.Div00.addChild(obj.name, obj);

            obj = new MaskEdit("MaskEdit01","125","78","231","28",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("6");
            obj.set_visible("true");
            this.Div00.addChild(obj.name, obj);

            obj = new Static("Static15_00","0","110","120","118",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("7");
            obj.set_text("메모");
            obj.set_cssclass("sta_WF_DetailLabel");
            obj.set_visible("true");
            ...
            obj = new Static("sta_11_00","119","110","326","118",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("8");
            obj.set_cssclass("sta_WF_DetailArea");
            obj.set_visible("true");
            this.Div00.addChild(obj.name, obj);

            obj = new TextArea("txt00","125","116","231","107",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("9");
            obj.set_visible("true");
            this.Div00.addChild(obj.name, obj);
            // Layout Functions
        ...
        this.on_initEvent = function()
        {
            ...
            this.Div00.form.Static11.addEventHandler("onclick",this.Div06_Static11_onclick,this);
        ...
        this.loadIncludeScript("Temp_List DetailH.xfdl");
