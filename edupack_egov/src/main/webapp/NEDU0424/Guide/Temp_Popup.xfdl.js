(function()
{
    return function()
    {
        ...
        {
            this.set_name("Guide_Popup01");
            this.set_titletext("Popup");
            if (Form == this.constructor)
            {
                this._setFormPosition(510,450);
            }
            ...
            obj = new Div("div_search","20","55","470","46",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Combo("cmb_dept","54","8","140","28",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("0");
            ...
            obj = new Static("Static01","0","8","54","28",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("1");
            obj.set_text("부서");
            obj.getSetter("leftbase").set("");
            obj.getSetter("topbase").set("");
            ...
            obj = new Static("Static00","244","8","54","28",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("2");
            obj.set_text("성명");
            obj.getSetter("leftbase").set("");
            obj.getSetter("topbase").set("");
            ...
            obj = new Edit("edt_name","298","8","140","28",null,null,null,null,null,null,this.div_search.form);
            obj.set_taborder("3");
            obj.set_visible("true");
            this.div_search.addChild(obj.name, obj);

            obj = new Grid("grd_list","20","136",null,"254","20",null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj.set_visible("true");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"88\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell text=\"법인\"/><Cell col=\"1\" text=\"부서\"/><Cell col=\"2\" text=\"성명\"/><Cell col=\"3\" text=\"사원번호\"/></Band><Band id=\"body\"><Cell text=\"bind:CORP_CODE\" displaytype=\"combotext\" edittype=\"combo\" combodataset=\"ds_corp\" combocodecol=\"CORP_CODE\" combodatacol=\"CORP_NAME\"/><Cell col=\"1\" text=\"bind:DEPT_CODE\"/><Cell col=\"2\" text=\"bind:FULL_NAME\"/><Cell col=\"3\" text=\"bind:EMPL_ID\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("btn_17","258","400","50","30",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("취소");
            ...
            obj = new Button("btn_16","203","400","50","30",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("확인");
            obj.set_cssclass("btn_POP_Btn");
            obj.set_visible("true");
            ...
            obj = new Static("sta00","20","20","213","35",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("화면 유형 - POPUP");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",510,450,this,function(p){});
        ...
        this.loadIncludeScript("Temp_Popup.xfdl");
