(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grd_list","10","149",null,"451","10",null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj.set_taborder("5");
            obj.set_text("화면 유형 - List Pasing");
            ...
            obj = new Div("Div00","369","grd_list:10","300","30",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("Div00");
            obj.set_url("Template::Temp_List Paging_Sub.xfdl");
            this.addChild(obj.name, obj);
            // Layout Functions
        ...
        {
            this._addPreloadList("fdl","Template::Temp_List Paging_Sub.xfdl");
        };
        ...
        this.loadIncludeScript("Temp_List Paging.xfdl");
