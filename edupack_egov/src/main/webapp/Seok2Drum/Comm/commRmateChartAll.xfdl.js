(function()
{
    return function()
    {
        ...
        {
            this.set_name("CommRmateChartAll");
        ...
        // User Script
        this.addIncludeScript("commRmateChartAll.xfdl","Lib::rMateChartH5.xjs");
        this.registerScript("commRmateChartAll.xfdl", function() {
        /**
        *  Necacro EduPack
        ...
        */
        ...
        this.loadIncludeScript("commRmateChartAll.xfdl");
