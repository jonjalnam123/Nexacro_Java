(function()
{
    return function()
    {
        ...
        {
            this.set_name("CmmUbiReport");
            this.set_titletext("Ubi Report Preview");
            this.getSetter("classname").set("UbiReport");
            if (Form == this.constructor)
            {
                this._setFormPosition(1024,730);
            }
            ...
            obj = new UbiReport("UbiViewer","1","1",null,null,"1","1",null,null,null,null,this);
            obj.getSetter("taborder").set("0");
            obj.getSetter("text").set("UbiViewer");
        ...
        // User Script
        this.registerScript("commUbiReport.xfdl", function() {
        /************************************************************************************
        * 뷰어 초기 설정
        ************************************************************************************/
        ...
        ************************************************************************************/
        ...
        this.loadIncludeScript("commUbiReport.xfdl");
