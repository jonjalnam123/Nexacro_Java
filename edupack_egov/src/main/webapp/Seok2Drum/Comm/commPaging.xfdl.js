(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("commPaging.xfdl", function() {
        /**
        *  Necacro EduPack
        ...
        */
        this.fnCreatePage = function(sFnCallback, nTotalCount, nRecords, nPage, nPageCount)
        {
            ...
            if (this.ufnIsNull(sPageView)) 	 sPageView = "all";
            if (this.ufnIsNull(nRecords)) 	 nRecords = 50;
            if (this.ufnIsNull(nPage)) 		 nPage = 0;
            if (this.ufnIsNull(nPageScaleC)) nPageScaleC = 10;
        ...
        /*     var objDivPaging = this.divPage;*/
            ...
            if (sPageView == "all" || sPageView == "number")
            {
        		...
        		objBtnFirst.set_cssclass("btn_WF_PagingDPrev");
        		...
        		objBtnEnd.set_cssclass("btn_WF_PagingDNext");
        		//objBtnEnd.set_text(">>");
        ...
        */
        ...
        this.loadIncludeScript("commPaging.xfdl");
