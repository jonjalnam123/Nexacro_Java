(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnFilterCancel","326","10","65","30",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("필터취소");
            obj.getSetter("uWord").set("popup.cancel");
            this.addChild(obj.name, obj);

            obj = new Button("btnUp","396","10","30","30",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_cssclass("btn_WF_ShuttleT");
            this.addChild(obj.name, obj);

            obj = new Button("btnDown","431","10","30","30",null,null,null,null,null,null,this);
            obj.set_taborder("3");
        ...
        // User Script
        this.registerScript("commGridFilter.xfdl", function() {
        /**
        *  Necacro EduPack
        ...
        */
        ...
        this.loadIncludeScript("commGridFilter.xfdl");
