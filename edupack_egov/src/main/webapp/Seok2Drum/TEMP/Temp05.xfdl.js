(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("Grid00","10","149",null,null,"10","50",null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Static("Static00_01","322","8","54","34",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("8");
            obj.set_text("부서");
            obj.set_cssclass("sta_WF_SearchLabel");
            this.Div00.addChild(obj.name, obj);

            obj = new Static("Static01_00","322","46","78","25",null,null,null,null,null,null,this.Div00.form);
            obj.set_taborder("9");
            obj.set_text("입사일자");
            obj.set_cssclass("sta_WF_SearchLabel");
            this.Div00.addChild(obj.name, obj);
            ...
            obj = new Static("Static00_00_00_00_00_00_00",null,"600","140","50","98",null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("H50");
            obj.set_cssclass("sta_WF_GSize");
            obj.set_visible("false");
            ...
            obj = new Button("btn01_00_00_01","653","605","30","30",null,null,null,null,null,null,this);
            obj.set_taborder("9");
            obj.set_cssclass("btn_WF_PagingDNext");
            obj.set_enable("true");
            this.addChild(obj.name, obj);

            obj = new Button("btn01_01_01","623","605","30","30",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_cssclass("btn_WF_PagingNext");
            this.addChild(obj.name, obj);

            obj = new Button("btn00_01_00","503","605","30","30",null,null,null,null,null,null,this);
            obj.set_taborder("11");
            obj.set_text("3");
            obj.set_cssclass("btn_WF_Paging");
            this.addChild(obj.name, obj);

            obj = new Button("btn00_00_01","473","605","30","30",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("2");
            obj.set_cssclass("btn_WF_Paging");
            this.addChild(obj.name, obj);

            obj = new Button("btn00_02","443","605","30","30",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_text("1");
            obj.set_cssclass("btn_WF_Paging");
            this.addChild(obj.name, obj);

            obj = new Button("btn01_00_02","413","605","30","30",null,null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_cssclass("btn_WF_PagingPrev");
            this.addChild(obj.name, obj);

            obj = new Button("btn01_05","383","605","30","30",null,null,null,null,null,null,this);
            obj.set_taborder("15");
